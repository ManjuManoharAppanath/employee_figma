      ...
      body: SingleChildScrollView(
        child: Column(
          ...
          Stack(clipBehavior: Clip.none,
              children: [
          GlobalAppbar(),
            Positioned(top: 100,left: 10,right: 16,
              child: Card(
                    ...
                    children: [
                      ...
                      Row(
                        ...
                        children: [
                          ...
                          Container(height: 50, width:70,
                            ...
                            decoration: BoxDecoration(
                              borderRadius: BorderRadius.circular(15),
                              gradient: LinearGradient(colors: [Color(0xff6BC492),Color(0xff498865)],)

                            ),
                            child: Row(
                              children: [ Icon(Icons.browse_gallery_rounded,
                      ...
                      Container(height: 30, width: 100,
                        ...
                        decoration: BoxDecoration(
                          ...
                          gradient: LinearGradient(colors: [Color(0xffE29B39),Color(0xffCE8130)]),
